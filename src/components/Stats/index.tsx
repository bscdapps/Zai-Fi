    ...
    <StatsWrapper>
      <Section column>
        ...
        >
          ...
          >
            ...
            <ColumnFigure
              heading="Spot Price"
              value={<Figure num={spotPrice} unit="VAI" />}
            />

            <ColumnFigure
              right
              heading="TWAP Price"
              value={<Figure num={twapPrice} unit="VAI" />}
            />
        ...
        >
          ...
          <Cell>
            ...
            {/* <TableRow
              left="LP Total:"
              right={<Figure num={poolTotalSupply} unit="CAKE-LP" />}
            />
            ...
            <TableRow
              left="Dai in LP:"
              right={<Figure num={pairBalanceDai} unit="VAI" />}
            /> */}
      ...
      <Section column>
        ...
        >
          ...
          <Cell>
            <SubHeading>ZAI-VAI LP</SubHeading>
            ...
            <TableRow
              left="Staged:"
              right={<Figure num={poolStaged} unit="CAKE-LP" />}
            />
            <TableRow
              left="Bonded:"
              right={<Figure num={poolBonded} unit="CAKE-LP" />}
            />
            <TableRow
              left="Total:"
              right={
