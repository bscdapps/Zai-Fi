...
const LiquidityModal = () => {
  ...
  const tabMap = {
    [LiquidityStages.Stage]: {
      ...
      helpText:
        'Depositing or withdrawing CAKE-LP requires you to be unlocked in the LP Pool',
    },
    ...
    [LiquidityStages.Bond]: {
      ...
      helpText:
        'Bonding or unbonding CAKE-LP will reset your locked timer in the LP Pool to 3 cycles',
    },
  }
  ...
  return (
    <Modal>
      <ModalColorRush>
        ...
        <ModalContentWrap>
          {txHash ? (
            ...
            <EnableTout copy="To Bond or Unbond CAKE-LP, you need to enable it first." />
          )}
        </ModalContentWrap>
      ...
      >
        ...
        <TableRow
          left="Wallet"
          right={<Figure num={uniBalance} unit="CAKE-LP" />}
        />
        <TableRow left="Staged" right={<Figure num={staged} unit="CAKE-LP" />} />
        <TableRow left="Bonded" right={<Figure num={bonded} unit="CAKE-LP" />} />
      </ModalContentWrap>
    </Modal>
  )
}
