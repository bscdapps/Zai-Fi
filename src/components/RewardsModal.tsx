...
const RewardsModal = () => {
  ...
  const tabMap = {
    ...
    [RewardsStages.Provide]: {
      ...
      helpText: (
        <React.Fragment>
          Provide earned Zai (with equivalent Dai) to compound bonded CAKE-LP.
    ...
    <Modal>
      <ModalColorRush>
        ...
        <ModalContentWrap>
          {txHash ? (
            ...
            <EnableTout copy="To Provide ZAI-VAI LP, you need to enable it first." />
          )}
        </ModalContentWrap>
      ...
      <ModalContentWrap>
        ...
        <TableRow
          ...
          right={<Figure num={daiBalance} round={4} unit="VAI" />}
        />
      </ModalContentWrap>
    </Modal>
  )
